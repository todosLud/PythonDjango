...
from coupons.models import Coupon #modello di sconto
...
class Cart:
    ...
    #proprieta del cupon
    @property
    def coupon(self):#serve a prendere il cupon
        if self.coupon_id:
            try:
    ...
    #aggiorno il totale dopo lo sconto
