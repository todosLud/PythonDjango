...
class Prodotti(models.Model):
    ...
    img_resize = ImageSpecField(source='img', processors=[ResizeToFill(600,800)], format='PNG', options={'quality' : 60})
    descrizione = RichTextField(blank=True)
    prezzo = models.DecimalField(max_digits=10, decimal_places=2)
    quantita = models.IntegerField("Quantita in magazzino", default=0)
